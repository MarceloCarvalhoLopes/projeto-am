...
INSERT INTO PEOPLE(NAME,ADDRESS,NUMBER,ADDITIONAL,NEIGHBORHOOD,ZIPCODE,CITY,STATE,ACTIVE) VALUES ('Logan','Main Street', '1', 'N','Williamsburg','11115-290','New York','NY',true);
INSERT INTO PEOPLE(NAME,ADDRESS,NUMBER,ADDITIONAL,NEIGHBORHOOD,ZIPCODE,CITY,STATE,ACTIVE) VALUES ('Anakin','Main Street', '2', 'N','West Village','11115-291','New York','NY',true);
INSERT INTO PEOPLE(NAME,ADDRESS,NUMBER,ADDITIONAL,NEIGHBORHOOD,ZIPCODE,CITY,STATE,ACTIVE) VALUES ('BarryAllen','Main Street', '3', 'N','Soho','11115-292','New York','NY',true);
INSERT INTO PEOPLE(NAME,ADDRESS,NUMBER,ADDITIONAL,NEIGHBORHOOD,ZIPCODE,CITY,STATE,ACTIVE) VALUES ('Superman','Main Street', '4', 'N','Massachusetts','11115-293','Worcester','MA',true);
INSERT INTO PEOPLE(NAME,ADDRESS,NUMBER,ADDITIONAL,NEIGHBORHOOD,ZIPCODE,CITY,STATE,ACTIVE) VALUES ('Diana Prince','Paradise Island', '5', 'N','The Magnificent Mile','11115-294','Chicago','IL',true);
